    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pnl', models.DecimalField(
                    decimal_places=17, default=0, max_digits=30)),
                ('active', models.BooleanField(default=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quote_volume', models.DecimalField(
                    decimal_places=8, max_digits=30)),
                ...
                ('time', timescale.db.models.fields.TimescaleDateTimeField(
                    interval='2 week')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(blank=True,
                 max_length=999, null=True, verbose_name='content')),
                ('is_sent', models.BooleanField(
                    default=False, verbose_name='is sent')),
                ('event', models.SmallIntegerField(blank=True, choices=[(1, 'Created'), (2, 'Updated'), (
                    3, 'Deleted'), (4, 'Trade Executed'), (5, 'Error Occurred')], null=True, verbose_name='event')),
                ('commit_time', models.DateTimeField(
                    auto_now_add=True, verbose_name='commit time')),
                ('send_time', models.DateTimeField(
                    blank=True, null=True, verbose_name='send time')),
                ('exception_id', models.CharField(blank=True,
                 max_length=255, null=True, verbose_name='exception id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_type', models.CharField(choices=[
                 ('BUY', 'Buy'), ('SELL', 'Sell')], max_length=4)),
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('crypto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='orders', to='market.cryptocurency')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('coin', models.CharField(blank=True,
                ...
                ('price', models.DecimalField(
                    decimal_places=17, default=0.0, max_digits=30)),
                ...
                ('logo', models.ImageField(blank=True, default='coins/XTVCUSDT.svg',
